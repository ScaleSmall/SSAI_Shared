...
export default function DataSourcePanel({ supabaseUrl, getToken }) {
  ...
  return (
    <div className="sc-ds-section">
      ...
      <p className="sc-subtitle">Connect the tools you already use to run your business — your CRM, invoicing app, or field service software. Connect as many or as few as you use. <strong>Every connected tool sharpens your customer outreach.</strong> <span className="sc-optional-badge">Optional</span></p>
